...
praise(template = "You are ${adverb} ${adjective}!")
```
oh and by the way, this site updates with every refresh and processes new information. Try it yourself and refresh this page to recieve a new compliment everytime: **`r praise(template = "You are ${adjective}!")`**
