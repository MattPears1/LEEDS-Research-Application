...
{\centering \includegraphics[width=8.64in,height=1.25\textheight]{table ttest} 
...
{\centering \includegraphics[width=5.33in,height=1.25\textheight]{clear} 

}

\caption{pre-post clear_understandable example}\label{fig:clearpic}
\end{figure}
