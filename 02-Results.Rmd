...
```{r CUQ scatter plot, eval=FALSE, message=FALSE, fig.align='center', fig.cap="CUQ Scatter Plot", warning=FALSE, include=FALSE}
library(readr)
...
Figure \@ref(fig:CUQ scatter plot) shows the CUQ scores as a scatter plot to highlight how there was a moderate distribution of results. Further exploration is required to understand which elements are causing this spread, and if it was due to problems within a small group of learners.
