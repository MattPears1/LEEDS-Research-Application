...
After usage, there was only agreement in Ease of Use- as shown in (\@ref(fig:Boxplotsplits9) as there are no 'Neutral' or disagree columns. Any learners with disagreement before using the CEPEH chatbots, after believed they were easy to use. 
