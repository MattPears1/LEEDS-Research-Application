...
```{r SUS keepusing,tab.cap="Keep using CEPEH chatbots", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r confidence, tab.cap="confidence using CEPEH chatbots", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Boxplot knowledge, echo=FALSE, fig.cap="Improvements in Knowledge", message=FALSE, warning=FALSE}
...
```{r Boxplot trust, echo=FALSE, fig.cap="Trust Chatbots POST use", message=FALSE, warning=FALSE}
...
```{r Boxplot personality, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Boxplotsplits9, echo=FALSE, fig.cap="Ease of Use Comparison", message=FALSE, warning=FALSE}
