...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{CEPEHQ\_tidy\_bing }\OtherTok{\textless{}{-}}\NormalTok{  CEPEHQ\_tidy}\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{total\_score =}\NormalTok{ positive }\SpecialCharTok{{-}}\NormalTok{ negative)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{CEPEHQ\_tidy\_bing }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarize}\NormalTok{(}\FunctionTok{max}\NormalTok{(total\_score), }\FunctionTok{min}\NormalTok{(total\_score)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(CEPEHQ\_tidy\_bing) }
\end{Highlighting}
\end{Shaded}
