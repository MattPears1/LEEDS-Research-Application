...
The TAM questions were analysed according to their subsets.
The first subset was Perceived Usefulness (PU)

The questions were:
1. Using CEPEH chatbots would enable me to accomplish tasks more quickly
...
\item
  My interactions with CEPEH chatbots would be clear and understandable
\item
  I would find CEPEH chatbots easy to use
\end{enumerate}

The scores as a percentage of agreement were:
66\% agreement for Perceived Usefulness (Average (1,2,3,4)/42 = 2.2 (Strong Perceived Usefulness)

64\% agreement for Perceived Ease of Use (Average (5,6,7,8)/42)= 2.3 (Strong Perceived Ease of Use)

Perceived Usefulness: There were not
