...
6 participants differed from the majority (33) who were student, as 3 were learning technologists, 2 were lecturers, and 1 was a doctor.
Although there could be a difference in these groups, the design was within- groups therefore each participants pre-usage metrics were the comparative control data, and participant differences cannot affect the evaluation.
...
\hypertarget{cuq-calcuation-tool-the-cuq-was-developed-by-researchers-at-ulster-university-see-cuq-and-as-the-calculation-can-be-complex-a-dedicated-calculation-tool-has-been-created.}{%
\subsection{CUQ Calcuation tool The CUQ was developed by researchers at Ulster University (see) \{CUQ\}) and as the calculation can be complex a dedicated calculation tool has been created.}\label{cuq-calcuation-tool-the-cuq-was-developed-by-researchers-at-ulster-university-see-cuq-and-as-the-calculation-can-be-complex-a-dedicated-calculation-tool-has-been-created.}}
...
\includegraphics[width=5.20833in,height=\textheight]{cuq.png}
