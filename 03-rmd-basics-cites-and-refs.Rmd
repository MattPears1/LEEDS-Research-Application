...
museum <- read_csv("HELM data final.csv")
museum %>%
leaflet() %>%
...
```{r MOHAMMED please make FREQ bar chart of top 15 Cities- sorted, echo=FALSE, message=FALSE, warning=FALSE}
