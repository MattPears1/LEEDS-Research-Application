...
```{r pre measures other, echo=FALSE, message=FALSE, warning=FALSE}

## table for currently used learning resources
preother <- subset(data, select = c("UseChatbotsFrequently","ChatbotsUsefulDailyPE1PRE","IncreaseAchievingPE2PRE", "AccomplishThingsQuicklyPE3PRE","IncreasesProductivityPE4PRE"))
preother <- na.omit(preother)
...
```{r cuq image, echo=FALSE, fig.align='center', fig.cap="A marvel-lous meme", message=FALSE, warning=FALSE, out.width="65%"}
