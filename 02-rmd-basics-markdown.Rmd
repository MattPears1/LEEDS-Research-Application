...
[](){<a href="https://www.ulster.ac.uk/research/topic/computer-science/artificial-intelligence/projects/
cuq" target="_blank">CUQ</a>}) and as the calculation can be complex a dedicated calculation tool has 
been created. 
...
![cuq.png](cuq.png){width=400px}

```{r cuq, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
