...
The CUQ was developed by researchers at Ulster University (see) {<a href="https://www.ulster.ac.uk/research/topic/computer-science/artificial-intelligence/projects/
cuq" target="_blank">CUQ</a>}) and as the calculation can be complex a dedicated calculation tool has been created. Please download the CEPEH CUQ calculation tool which has all of the data entered, so you can see the CEPEH CUQ scoring.


<center>
[click here to download CUQ calc tool](CUQ-Calculation-Tool.xlsx)
![](cuq.png){width="500px"}</center>
