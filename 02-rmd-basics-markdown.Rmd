...
knitr::kable(curr<-curr%>% filter(CurrentMaterials %in% c("Books","Online videosinteractive material", "Online journalsbooks","1 to 1 workshops or lectures", format('html'))) %>% group_by(CurrentMaterials) %>% count(CurrentMaterials),"pipe")
