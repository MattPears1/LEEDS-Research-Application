...
Therefore, there are 42 points of data in the condition before testing, and 126 data points after testing the 4 chatbots- for a total of `r count(data)` row of data, 5 per participant. There were 78 questions asked in total, therefore the full dataset has over 4000 cells recorded.
...
```{r profession table 1, echo=FALSE, message=FALSE, warning=FALSE, comment=NA, paged.print=FALSE}

##table for who they are/ student etc
